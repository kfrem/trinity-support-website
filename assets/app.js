...
function renderDashboard(){
  ...
  document.getElementById('total-docs').textContent=records.length;
  document.getElementById('priority-docs').textContent=records.filter(r=>dashboardStatus(r)==='Priority watch').length;
